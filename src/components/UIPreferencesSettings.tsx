        ...
        <div className="space-y-6">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            className={`p-1 rounded hover:bg-sky-100 transition-colors ${
                              index === favouritedNavTabs.length - 1 || saving
                                ? 'opacity-30 cursor-not-allowed'
                                : 'text-sky-600'
                            }`}
                          ...
                          <button
                            ...
                            className={`p-1 rounded hover:bg-amber-100 transition-colors ${
                              favouriteNavTabs.length === 1 || saving
                                ? 'opacity-30 cursor-not-allowed'
                                : 'text-amber-600'
                            }`}
                ...
                <div className="grid grid-cols-3 gap-2">
                  {contrastOptions.map((option) => (
                    <button
                      ...
                      disabled={saving}
                      className={`p-3 rounded-lg border-2 transition-all ${
                        config.contrastLevel === option.value
                          ? 'border-orange-500 bg-orange-50'
                          : 'border-gray-200 hover:border-orange-300'
                      } ${saving ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <button
              onClick={handleReset}
              disabled={saving}
              className={`w-full flex items-center justify-center gap-2 px-4 py-3 border-2 border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors ${
                saving ? 'opacity-50 cursor-not-allowed' : ''
              }`}
            >
              <RotateCcw size={20} />

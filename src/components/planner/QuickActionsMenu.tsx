            ...
            {visibleActions.map((action) => {
              ...
              return (
                <button
                  ...
                  className="w-full px-4 py-3.5 text-left flex items-center gap-3 hover:bg-gray-50 active:bg-gray-100 transition-colors min-h-[56px]"
                >
                  <div className={`p-2.5 rounded-lg ${action.color || 'bg-blue-100'} flex-shrink-0`}>
                    <Icon className={`w-5 h-5 ${action.iconColor || 'text-blue-600'}`} />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="text-base font-medium text-gray-900">{action.label}</div>
                    {action.description && (

/**
 * Calendar Guide - Mobile View
 * 
 * Phase 9: Mobile-first Calendar guide using full screen with swipeable sections.
 */

import { useState } from 'react';
import { X, ChevronLeft, ChevronRight, ArrowLeft } from 'lucide-react';
import { CalendarGuideCard } from './CalendarGuideCard';
import { getAllCalendarGuideSections, type CalendarGuideSection } from './calendarGuideContent';

interface CalendarGuideMobileProps {
  isOpen: boolean;
  onClose: () => void;
  onBack?: () => void;
}

export function CalendarGuideMobile({
  isOpen,
  onClose,
  onBack,
}: CalendarGuideMobileProps) {
      ...
      <div className="fixed inset-0 z-50 flex flex-col bg-white safe-top safe-bottom">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6">
          <div className="max-w-md mx-auto">
            <CalendarGuideCard section={currentSection} variant="mobile" />
          </div>
        </div>

                  ...
                  {dayEvents.map(({ event, startMinutes, endMinutes }) => {
                    ...
                    return (
                      <div
                        ...
                        className={`absolute left-0.5 right-0.5 rounded-md shadow-sm cursor-pointer active:shadow-md active:scale-[0.98] transition-all overflow-hidden ${
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        color: getContrastColor(getEventTypeColor(event)),
                      }}
                    >
